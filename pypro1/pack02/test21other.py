...
def process():
    ...
    print()
    iu = pack02.test21singer()   
    print('타이틀 송 : ',iu.title_song)
    iu.sing()
    # print('소속사 가 '+iu.co + '인 가수의 노래 '+iu.title_song) => err : iu는 co가 없기 때문에
    print(id(pack02.test21singer.Singer),id(iu)) # 2pack029918336 2495508728144 다름
    
    print()
    bp = pack02.test21singer.Singer 
    print(id(pack02.test21singer.Singer),id(bp)) # 230pack0205200 2307711105200 => 주소 같음
