...
# ctab = pd.crosstab(index=data1['education'], columns=data1['smoking'], normalize=True) # 비율로 나옴
# print(ctab)
...
# 판정 : p 0.0008182 < 0.05 이기 때문에 유의미한 수준(알파=0.05)에서 귀무가설을 기각한다.
# 발생된 데이터는 우연히 발생된 자료가 아니다.
# 교육수준과 흡연율 간에 관련이 있다.
# 참고 : Yeats의 연속성 보정(자유도가 1일때 보정이 필요)