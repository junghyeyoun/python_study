...
# 동일한가를 검정하게 된다. 두 개 이상의 범주형 자료가 동일한 분포를 갖는 모집단에서 수출된 것인지 검정하는 방법이다.
...
print(set(data['method']),set(data['survey']))
...
# chi2:102.75202494484225, p:1.1679064204212775e-18
# 해석 : pvalue : 1679064204212775e-18 < 0.05이므로 귀무기각
# 위 수집 데이터는 표본
# 만약에 위 수집 데이터가 모집단이라면 표본추출해서 작업
