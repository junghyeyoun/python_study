...
# 예) 6개월기간동안 초코파이를 먹기 전후의 몸무게가 같은가?

# 실습) 복부 수술 전 9명의 몸무게와 복부 수술 후 몸무게 변화

# 귀무 : 복부 수술 전 몸무게와 복부 수술 후 몸무게 변화 차이가 없다.
# 대립 : 복부 수술 전 몸무게와 복부 수술 후 몸무게 변화 차이가 있다.
...
# 판정 : p-value -> 0.00633 < 0.05이므로 귀무가설 기각. 복부 수술 전 몸무게와 복부 수술 후 몸무게 변화 차이가 있다. 